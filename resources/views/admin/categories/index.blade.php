        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div
                ...
                <div
                    ...
                    <h3 class="text-lg font-semibold text-white">Categories</h3> <x-button type="primary" tag="a"
                        href="{{ route('admin.categories.create') }}"
                        class="bg-green-600 hover:bg-green-700 text-white shadow-md"> Add Category </x-button>
                </div> <!-- Table -->
                            ...
                            @foreach ($categories as $category)
                                <tr
                                    ...
                                    <td class="px-6 py-4 text-sm"> <span
                                            ...
                                            {{ $category->created_at->format('M d, Y') }} </span> </td>
                                    <!-- Updated At -->
                                    <td class="px-6 py-4 text-sm"> <span
                                            class="inline-flex items-center px-3 py-1 rounded-full bg-blue-100 text-blue-800 font-semibold">
                                            {{ $category->updated_at->format('M d, Y') }} </span> </td> <!-- Actions -->
